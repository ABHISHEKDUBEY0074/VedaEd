    ...
    <div className="p-0 m-0 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3">
        <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
          <div className=" font-semibold text-gray-500 uppercase tracking-wide">
            Total Timetables
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl shadow-sm flex flex-col">
          <div className="border-b border-gray-100 px-5 py-4 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <button className="px-3 py-2 border border-gray-200 rounded-lg  hover:bg-gray-50 flex items-center gap-1">
                <FiFilter size={14} />
                Filters
              </button>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className=" text-gray-400 text-right space-y-1">
                        <p>Class Teacher</p>
                    ...
                    <div className="flex items-center gap-2 mt-4">
                      <button className="flex items-center gap-1  text-blue-600 font-semibold uppercase tracking-wide">
                        View Draft
                        <FiChevronRight size={12} />
                      </button>
                      <span className="text-gray-300">•</span>
                      <button className="flex items-center gap-1  text-gray-500 uppercase tracking-wide">
                        Change Log
                        <FiChevronRight size={12} />
                      </button>
                    </div>
          ...
          {selectedTimetable ? (
            <>
                ...
                {loadingTimetable ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-[760px] w-full border border-gray-200 rounded-lg overflow-hidden">
                      <thead className="bg-gray-50  font-semibold text-gray-500 uppercase tracking-wide">
                        <tr>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-white text-blue-700 border border-blue-200 rounded-lg  hover:bg-blue-100">
                  Resolve now
